/**
 * stakeholders.js — part of the S5 structural split (ADR-0033). Static reference data. Not currently read anywhere (F-19 no-unused-vars baseline) — moved verbatim, not deleted.
 */

/* eslint-disable no-unused-vars --
 * F-19 baseline (docs/ANALYSIS.md) — genuinely unused before the split too, moved
 * verbatim per "move code, do not improve it" (ARCHITECTURE.md S5 rule 1).
 */
